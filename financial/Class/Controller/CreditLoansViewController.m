...
#import "CreditLoansViewController.h"
#import "Public.h"
#import "AppListCell.h"
#import "WebModel.h"
#import "WebViewController.h"

@interface CreditLoansViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>{
...
@implementation CreditLoansViewController
...
-(void)initData{
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        //获得所有应用数据
        NSString *plistPath = [[NSBundle mainBundle] pathForResource:@"CreditLoans" ofType:@"plist"];

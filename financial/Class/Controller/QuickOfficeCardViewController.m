//
//  QuickOfficeCardViewController.m
//  financial
//
...
#import "QuickOfficeCardViewController.h"
#import "Public.h"
#import "AppListCell.h"
#import "WebModel.h"
#import "WebViewController.h"

@interface QuickOfficeCardViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>{
...
@implementation QuickOfficeCardViewController
...
-(void)initData{
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        //获得所有应用数据
        NSString *plistPath = [[NSBundle mainBundle] pathForResource:@"QuickOfficeCard" ofType:@"plist"];
